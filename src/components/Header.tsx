...
import { Shield, Send, RefreshCw, Sparkles, X } from 'lucide-react';
    ...
    >
      <div className="mx-auto max-w-7xl px-2.5 sm:px-6 lg:px-8">
        <div className="flex h-12 sm:h-13 items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5 shrink-0 min-w-[65px]">
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-400 text-xs font-bold tracking-wide shadow-sm">
          ...
          {/* Right: Actions */}
          <div className="flex items-center justify-end gap-1.5 shrink-0 min-w-[65px]">
            <button
              type="button"
              onClick={onRefresh}
              disabled={loading}
              ...
              className="rounded-xl border border-zinc-800 bg-zinc-900 p-1.5 text-zinc-300 transition-colors hover:border-zinc-700 hover:text-white disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer"
            >
            ...
            {isTgMiniApp && (
              <button
                ...
                className="rounded-xl border border-zinc-800 bg-zinc-900 p-1.5 text-zinc-400 transition-colors hover:border-zinc-700 hover:text-white cursor-pointer active:scale-95"
              >
