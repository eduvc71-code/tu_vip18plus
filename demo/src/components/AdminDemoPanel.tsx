...
export const AdminDemoPanel: React.FC<AdminDemoPanelProps> = ({
  ...
  return (
    <div className="flex-1 w-full max-w-4xl mx-auto flex flex-col bg-zinc-900 border border-zinc-800 rounded-none sm:rounded-3xl shadow-2xl overflow-hidden my-0 sm:my-3">
      ...
      <div className="border-b border-zinc-800 bg-zinc-950/80 p-3 sm:p-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                <h2 className="truncate text-base font-bold text-white sm:text-lg">Panel Administrativo</h2>
                <span className="rounded-full border border-amber-500/40 bg-amber-500/15 px-2 py-0.5 text-[10px] font-mono font-bold uppercase tracking-[0.12em] text-amber-300">
                  Demo
                </span>
              </div>
              <p className="text-[11px] leading-snug text-zinc-400 sm:text-xs">
                Gestiona contenido y prueba los simuladores en vivo.
              </p>
            </div>
          </div>
          ...
          <div className="flex w-full flex-wrap items-stretch gap-2 sm:w-auto sm:justify-end">
            <button
              ...
              className="flex items-center justify-center gap-1.5 rounded-xl border border-red-500/30 bg-red-500/10 px-3 py-2 text-[10px] font-bold text-red-400 transition-all hover:bg-red-500/20 sm:text-xs"
            ...
            <button
              ...
              className="flex min-w-[160px] flex-1 items-center justify-center gap-1.5 rounded-xl border border-amber-300 bg-amber-400 px-2.5 py-2 text-[10px] font-black text-black shadow-lg shadow-amber-500/20 transition-all hover:bg-amber-300 sm:flex-none sm:text-xs"
            ...
            <button
              ...
              className="flex min-w-[120px] flex-1 items-center justify-center gap-1.5 rounded-xl border border-zinc-700/60 bg-zinc-800 px-2.5 py-2 text-[10px] font-semibold text-zinc-300 transition-all hover:bg-zinc-700 sm:flex-none sm:text-xs"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-4 backdrop-blur-sm">
          <div className="relative w-full max-w-md overflow-hidden rounded-[28px] border border-amber-500/40 bg-gradient-to-b from-zinc-950 via-zinc-950 to-zinc-900 p-5 shadow-[0_30px_80px_rgba(0,0,0,0.7)]">
            ...
            <div className="relative z-10 space-y-5 pt-3 text-center">
              ...
              <button
                type="button"
                className="flex w-full items-center justify-center gap-2 rounded-2xl bg-amber-400 px-4 py-3 text-base font-black text-black shadow-lg shadow-amber-500/25 transition hover:bg-amber-300"
              >
      ...
      <div className="flex-1 p-3.5 sm:p-6 overflow-y-auto space-y-6">
          ...
          <form onSubmit={handleProfileSave} className="space-y-4">
            <div className="bg-zinc-950 p-4 sm:p-5 rounded-2xl border border-zinc-800 space-y-4">
              ...
              <div className="pt-2 border-t border-zinc-800 space-y-3">
                ...
                <button
                  type="button"
                  onClick={() => showAlert('Versión Demo')}
                  className="w-full py-2.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-300 font-bold text-xs uppercase tracking-wider transition-all cursor-pointer shadow-md mt-2"
                >
        ...
        {activeTab === 'pagos' && (
          <div className="bg-zinc-950 p-4 sm:p-5 rounded-2xl border border-zinc-800 flex flex-col">
